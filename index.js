...
function timeTableAll(){
    ...
    setData(today);
    document.querySelector('.timetable div h2').innerHTML = "Study Remainder";
}
...
document.querySelector('.timetable div h2').innerHTML = "Today's Reminder"; //To prevent overwriting the heading on loading;